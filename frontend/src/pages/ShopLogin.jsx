...
const ShopLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const isPhone = /^0\d{9}$/.test(formData.emailOrPhone);
      const loginData = {
      ...
      if (isEmail) {
        ...
        loginData.username = formData.emailOrPhone.toLowerCase();
      }
    ...
    <div className="min-h-screen bg-dark-900 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-white mt-4">Shop Login</h2>
        ...
        <form onSubmit={handleSubmit} className="card space-y-6">
          <div>
            ...
            <input
              ...
              placeholder="username, shop@example.com, or 0700412580"
              required
          ...
          <p className="text-center text-gray-400">
            ...
            <Link to="/shop/signup" className="text-primary-500 hover:underline">
              Sign Up
            </Link>
          </p>
        </form>
