...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let errorMessage = 'Invalid credentials. Please check your username and password and try again.';
        ...
        <form onSubmit={handleSubmit} className="card space-y-6">
          <div>
            ...
            <input
              ...
              placeholder="username, admin, or admin@example.com"
              required
